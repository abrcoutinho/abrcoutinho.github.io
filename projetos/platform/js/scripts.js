...
function expandTopBar(e) {
  const header = document.getElementById("header");
  const scrolledDown = document.body.scrollTop > 10 || document.documentElement.scrollTop > 10;
...
window.addEventListener('scroll', expandTopBar);


// Documentation page
if (window.location.href.indexOf("/documentation") > -1) {
  header.classList.add("scrolled");
  window.removeEventListener('scroll', expandTopBar);
  document.querySelector('#header .menu li:first-child').style.display = 'none';
}

// Trip API documentation page
if (window.location.href.indexOf("/trip") > -1) {
  document.getElementById('trip-submenu').classList.add('expanded');
}
// Planning API documentation page
if (window.location.href.indexOf("/planning") > -1) {
  document.getElementById('planning-submenu').classList.add('expanded');
}
...
// Language buttons
const btLang1 = document.querySelector('#langs a:first-child');
const btLang2 = document.querySelector('#langs a:nth-child(2)');
const btLang3 = document.querySelector('#langs a:nth-child(3)');
const btLang4 = document.querySelector('#langs a:nth-child(4)');

if (window.location.href.indexOf("/pt") > -1) {
  btLang1.innerHTML = 'PT';
  btLang1.href += 'pt';
  btLang1.title = 'Português';
  btLang2.innerHTML = 'EN';
  btLang2.href += 'en'
  btLang2.title = 'English';
  btLang3.innerHTML = 'ES';
  btLang3.href += 'es'
  btLang3.title = 'Español';
  btLang4.innerHTML = 'FR';
  btLang4.href += 'fr'
  btLang4.title = 'Français';
} else if (window.location.href.indexOf("/es") > -1) {
  btLang1.innerHTML = 'ES';
  btLang1.href += 'es'
  btLang1.title = 'Español';
  btLang2.innerHTML = 'EN';
  btLang2.href += 'en'
  btLang2.title = 'English';
  btLang3.innerHTML = 'PT';
  btLang3.href += 'pt';
  btLang3.title = 'Português';
  btLang4.innerHTML = 'FR';
  btLang4.href += 'fr'
  btLang4.title = 'Français';
} else if (window.location.href.indexOf("/fr") > -1) {
  btLang1.innerHTML = 'FR';
  btLang1.href += 'fr'
  btLang1.title = 'Français';
  btLang2.innerHTML = 'PT';
  btLang2.href += 'pt';
  btLang2.title = 'Português';
  btLang3.innerHTML = 'EN';
  btLang3.href += 'en'
  btLang3.title = 'English';
  btLang4.innerHTML = 'ES';
  btLang4.href += 'es'
  btLang4.title = 'Español';
} else {
  btLang1.innerHTML = 'EN';
  btLang1.href += 'en'
  btLang1.title = 'English';
  btLang2.innerHTML = 'PT';
  btLang2.href += 'pt'
  btLang2.title = 'Português';
  btLang3.innerHTML = 'ES';
